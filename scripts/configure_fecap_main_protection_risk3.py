#!/usr/bin/env python3
"""Instala uma exceção Owner Risk3 temporária para proteger fecap-clipping-automation/main."""
...
ACTION_ID = "fecap.main-protection.dev"
SCOPE = "repo://ericson-j-santos/fecap-clipping-automation/branch/main"
MANAGED_BY = "fecap-main-protection-once"
ENABLE_CONFIRM = "ENABLE-FECAP-MAIN-PROTECTION-ONCE"
DISABLE_CONFIRM = "DISABLE-FECAP-MAIN-PROTECTION-ONCE"
EVIDENCE_PATH = "evidence/private/main-protection-risk3.json"
COMMAND = [
    "python",
    "scripts/run_fecap_main_protection_local.py",
    "--output",
    EVIDENCE_PATH,
]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Autoriza uma proteção Risk3 única do FECAP/main")
