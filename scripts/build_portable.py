...
SAFE_FILES = (
    ...
    "scripts/knewin-session-capture.ps1",
    "scripts/knewin_session_bootstrap.py",
    "scripts/prepare_knewin_collector.py",
    "scripts/publish_onedrive_homologation.py",
    "scripts/publish_sharepoint_homologation.py",
    "scripts/run_homologation_pipeline.py",
    "scripts/run_monthly_operational_e2e.py",
    ...
    "tests/test_homologation_pipeline.py",
    ...
    "tests/test_monthly_operational_e2e.py",
    "tests/test_knewin_guided_probe.py",
    "tests/test_knewin_runtime_validation.py",
    "tests/test_knewin_session_collector.py",
    "tests/test_knewin_windows_bootstrap_contract.py",
    "tests/test_knewin_gateway_bootstrap.py",
    "tests/test_onedrive_homologation.py",
    "tests/test_operational_workbook.py",
